          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl p-1 shadow-2xl border border-slate-700/50">
            <div className="bg-slate-900 rounded-3xl p-6 min-h-[600px] flex flex-col">
              ...
              <motion.div
                ...
                className="bg-slate-800/60 rounded-2xl p-6 mb-6 border border-slate-700/30"
              >
              ...
              <motion.div
                ...
                className="bg-slate-800/60 rounded-2xl p-6 border border-slate-700/30 flex-1 flex flex-col"
              >
